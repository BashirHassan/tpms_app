...
const create = async (req, res, next) => {
  try {
    ...
    const fields = [
      ...
      'max_supervision_visits', 'max_gps_accuracy_meters', 'scoring_type', 'max_students_per_merged_group',
...
const update = async (req, res, next) => {
  try {
    ...
    const allowedFields = [
      ...
      'inside_distance_threshold_km', 'max_supervision_visits', 'max_gps_accuracy_meters', 'scoring_type',
